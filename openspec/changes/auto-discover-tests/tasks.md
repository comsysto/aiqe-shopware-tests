...
- [x] 3.3 Implement DOM element extraction per page: nav links, buttons, form fields, headings — collected into a structured map
...
- [x] 4.1 Implement JSON snapshot writer: serialize URL, title, journey hint, elements, auth_required to `build/discovery/<slug>.json`
- [x] 4.2 Implement screenshot capture per page using `Selenide.screenshot()` writing to `build/discovery/<slug>.png`
